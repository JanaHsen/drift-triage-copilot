...
class Investigation(Base):
    ...
    hil_items: Mapped[list["HILInboxItem"]] = relationship(back_populates="investigation")
    audit_entries: Mapped[list["AuditLog"]] = relationship(back_populates="investigation")
